...
ALARM_PATH := vendor/ZSOMBII_UI/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ZSOMBII_UI/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ZSOMBII_UI/prebuilt/common/media/audio/ringtones
